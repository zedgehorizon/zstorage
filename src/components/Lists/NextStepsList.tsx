    ...
    <div className=" relative z-10 p-4 text-sm leading-relaxed text-white b rounded-3xl shadow-md">
      ...
      <ol className="list-decimal ml-4 mt-4">
        ...
        <li className="mb-4">
          ...
          <p>
            Open the DNS control panel of your domain via your domain provider (e.g. GoDaddy, NameCheap, CloudFlare). You will need to setup a new CNAME and TXT
            record as mentioned below.
          </p>
        </li>
        <li className="mb-4">
        ...
        <li className="mb-4">
          ...
          <p>
            ...
            https://pepe1.yourdomain.com) in a browser to check if it resolves to your data asset. Based on how the IPFS network works, it may take time for it
            to resolve and testing the domain multiple times can actually speed up the DNS linking.
          </p>
        </li>
      </ol>
    </div>
