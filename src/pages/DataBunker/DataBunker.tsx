...
const DataBunker = () => {
  const { availableSpaceToUpload, maxSpace, availableBandwidthToUpload, maxBandwidth, accountTier } = useHeaderStore((state: any) => ({
  ...
  const handleUpgradeClick = (tier: "Premium" | "Gateway") => {
  ...
  return (
    <>
      <UpgradeModal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} tier={selectedTier} />
