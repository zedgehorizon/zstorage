...
const FileCard: React.FC<FileCardProps> = (props) => {
  ...
  return (
    <div className="flex text-accent flex-row items-center p-4 justify-center gap-3 border-b border-accent/20 w-[50rem]">
      ...
      <Button className="border border-accent p-2 hover:bg-accent/50 bg-accent/10 rounded-full flex items-center justify-center" onClick={onDelete}>
