  ...
  return (
    <div className="w-full h-[20%] flex flex-row items-center justify-center ">
      <div className="flex flex-col justify-center items-center gap-4">
        ...
        <label className="text-foreground/80 z-2">Tokenization Strategy</label>
      </div>
      <img className="-mt-16 opacity-30" src={arrowRight}></img>
      <div className="flex flex-col justify-center items-center gap-4 opacity-30">
        <span
          className={cn(
            "bg-muted text-2xl font bold p-4 px-7 max-w-[5rem] rounded-3xl border border-accent text-center",
        ...
        <label className="text-foreground/80 text-center">Data Asset Selection</label>
      </div>
      <img className="mt-8 opacity-30" src={arrowDownRight}></img>
      <div className="flex flex-col justify-center items-center gap-4 opacity-30">
        <span
          className={cn(
            "bg-muted text-2xl font bold p-4 px-7 max-w-[5rem] rounded-3xl border border-accent text-center",
        ...
        <label className="text-foreground/80 text-center">Target Blockchain</label>
      </div>
      <img className="-mt-16 opacity-30" src={arrowRight}></img>
      <div className="flex flex-col justify-center items-center gap-4 opacity-30">
        <span
        ...
        <span className=" text-foreground/80 max-w-[8rem] text-center">Minting Admin</span>
      </div>
    </div>
  );
};
